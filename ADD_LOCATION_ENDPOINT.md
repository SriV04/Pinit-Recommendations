...
1. **src/api/proximal_api.py**
   - Added imports for requests, json, os
   - Added Supabase service import
   - Added new Pydantic models: `AddLocationRequest`, `AddLocationResponse`
...
2. **src/supabase_client/supabase_service.py**
